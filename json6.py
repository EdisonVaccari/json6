...
if st.button("Processar Dados JSON"):
    try:
        ...
        with col1:
            ...
            if st.button("Copiar Pedidos da Inicial"):
                st.write("Pedidos da Inicial copiados para a área de transferência!")
        ...
        with col2:
            ...
            if st.button("Copiar Preliminares da Contestação"):
                st.write("Preliminares e Prejudiciais da Contestação copiados para a área de transferência!")
